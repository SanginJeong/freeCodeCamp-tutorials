...
const $person_image = document.querySelector('#person_image');
...
const showPerson = (person) =>{
  $person_image.src = reviews[person].img;
...
window.addEventListener("DOMContentLoaded", ()=>{
  $person_image.src = reviews[currentPerson].img;
...
$random_btn.addEventListener('click', ()=>{
  currentPerson = ~~(Math.random()*reviews.length);
  showPerson(currentPerson);
})